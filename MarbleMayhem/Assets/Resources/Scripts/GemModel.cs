...
public class GemModel : MonoBehaviour
{
	...
	public Gem owner;			// Pointer to the parent object.
	...
	public void init(int gemType, Gem owner) {
        ...
        gameObject.tag = "gemModel";
		mat = GetComponent<Renderer>().material;								// Get the material component of this quad object.
        GetComponent<Renderer>().sortingLayerName = "Fore";
        ...
        BoxCollider2D circ = gameObject.AddComponent<BoxCollider2D>(); 
